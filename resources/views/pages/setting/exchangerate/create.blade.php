                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="from_currency" id="from_currency" class="form-control select2 @error('currency') is-invalid @enderror">
                                    <option value="">{{ __('Select currency') }}</option>
                                    @foreach ($currencies as $id => $name)
                                        <option value="{{ $id }}" {{ old('currency') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                                @error('currency')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="to_currency" id="to_currency" class="form-control select2 @error('currency') is-invalid @enderror">
                                    <option value="">{{ __('Select currency') }}</option>
                                    @foreach ($currencies as $id => $name)
                                        <option value="{{ $id }}" {{ old('currency') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
